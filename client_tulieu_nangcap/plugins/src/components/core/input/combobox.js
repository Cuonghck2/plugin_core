          ...
          async bindSelectedData() {
            ...
            if (vm.dataForm[vm.config["model"]]) {
                ...
                if (vm.comp == 'TinhThanh') {
                    ...
                    objectPick = window.dotize.dotize.convert(objectPick);
                ...
                console.log('vm.dataForm vm.dataForm ', vm.dataForm );
            }
              ...
              if (vm.config.hasOwnProperty('link')) {
                  ...
                  for (const link of vm.config.link) {
                      ...
                      let bodyQuery = {
                          ...
                          "_source": {
                              "includes": link.collection == 'C_TinhThanh' && shortTitle == '1' ? ['MaMuc', 'TenMuc', 'type', 'TenMuc_RutGon'] : vm.config.column,
                          },
                          "query": {
                              "bool": {
                                  "filter": {
                      ...
                      if (link.hasOwnProperty('condition') && link.condition.length > 0) {
